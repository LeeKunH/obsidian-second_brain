...
하루 - 주간 - 월간 - 연간 **계획/행동 방향성** 반복해서 **시뮬레이션을 머릿속에서 돌린다.** 내가 할 행동들에 익숙해진다.  
	
**Plan 계획 - Do 행동 - See 제3입장**에서 객관적으로 바라본다/피드백한다.
	
틈틈 시간 활용 > **핵심 목표-명확화 행동들을 복기한다.**
ex) 학습한 내용 등
...
### - 4-9
긍정적으로 바라볼 때 나는 신중한 사람이다. 하지만 부정적인 시각으로는 걱정이 많은 편이다. 따라서 지금까지는 어떤 결정, 선택을 내릴 때마다, 항상 걱정과 고민 반, 기대와 설렘 반을 가지고 선택해왔다.  
	  
결정을 내리면서 '내가 이 일을 제대로 해내지 못하면 어떡하지?', '예상치 못한 상황이 발생하면 어떡하지?' 등과 같은 생각들이 있었고 반면, 해당 행동을 잘 했을 때, 100% 달성해 내 인생의 경험치로 만들었을 때 **모습을 상상하며 기대와 설렘**도 가지고 있었다.
	
그동안은 주로 걱정과 고민에 초점이 맞춰 소극적으로 행동해왔다. 하지만 앞으로는 선택의 기로에 섰을 때, 행동에 대한 이유-근거가 명확하다면 100% 달성한 내 모습을 기대하고 설렘의 감정 쪽으로 선택해 행동한다.  
	  
그게 내가 추구하는 가치관에 있어 이득이다.
...
### - 5-1
ㅡ
하루를 시작할 때 미리 나에게 주어진 하루에 소중함과 감사함을 느끼면서 하루를 시작한다.
...
따라서 현재 삶에서 이루고 싶은 것이 있을 땐 **전날/과거**를 어떻게 보냈건 간에 과거를 **수정-기록-피드백**은 하되 과거에 사로잡혀 있지 않는다. 어차피 지나갔고 변하지 않는다. 나에게 주어진 이 하루에 **집중**한다/눈앞에 보이는 오늘 이 하루를 열심히 내 것으로 만든다. 미래를 **기대**하면서 행동한다.   
	
**과거의 경험치**으로 현재의 삶을 조금씩 더 좋은 방향성으로 행동한다.
